...
export default function ResourcesPage() {
  ...
  const categories: Category[] = [
    { id: "article", name: "Articles", icon: <BookOpen className="w-5 h-5" />, count: resources.filter(r => r.category === "article").length },
    { id: "video", name: "Videos", icon: <Video className="w-5 h-5" />, count: resources.filter(r => r.category === "video").length },
    { id: "audio", name: "Audio", icon: <Headphones className="w-5 h-5" />, count: resources.filter(r => r.category === "audio").length },
    { id: "exercise", name: "Exercises", icon: <BookOpen className="w-5 h-5" />, count: resources.filter(r => r.category === "exercise").length }
  ];
